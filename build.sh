...
PLUGIN_ZIP="$DIST_DIR/deeppipe-mobile-v0.2.0.zip"
BUNDLE_ZIP="$DIST_DIR/DeepPipe_QField_API_Test_v0.2.0.zip"
...
cp "$PLUGIN_ZIP" "$STAGING_DIR/plugin-install/deeppipe-mobile-v0.2.0.zip"
